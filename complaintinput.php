...
<form id="infocontainer" action="" method="post">
    ...
    <div class="row">
      ...
      <select id="existing" name="customer_id">
        <optgroup label="Customer Name">
          <?php $result = pg_query_params($db, "SELECT * FROM customer", []); while($row = pg_fetch_assoc($result)) echo '<option value="'.$row['customer_id'].'">'.$row['fname'].' '.$row['lname'].'</option>'."\n"; ?>
        </optgroup>
    ...
    <div class="row">
      ...
      <select id="employee_name" name="employee_id">
        <optgroup label="Employee Name">
          <?php $result = pg_query_params($db, "SELECT * FROM employee", []); while($row = pg_fetch_assoc($result)) echo '<option value="'.$row['employee_id'].'">'.$row['employee_fname'].' '.$row['employee_lname'].'</option>'."\n"; ?>
        </optgroup>
        <optgroup label="Other">
